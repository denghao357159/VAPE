...
public class ACheckBox extends View implements Checkable{
     ...
     private static final String KEY_INSTANCE_STATE = "InstanceState";
        ...
        private static final int COLOR_CHECKED = Color.parseColor(AppConfig.theme[5]);//选择颜色
        private static final int COLOR_FLOOR_UNCHECKED = Color.parseColor("#DFDFDF");//未选择时的外环颜色
    ...
    private void init(Context context) {
            ...
            mStrokeWidth =  AppConfig.dp2px(context,0);
            
            //AppConfig.dp2px(context, 80);
        ...
        public void setChecked(boolean checked) {
            ...
            invalidate();
            if (mListener != null) {
                mListener.onCheckedChanged(ACheckBox.this, mChecked);
            }
        }
        ...
        private int measureSize(int measureSpec) {
            int defSize = AppConfig.dp2px(getContext(), DEF_DRAW_SIZE);
        ...
        public interface OnCheckedChangeListener {
            void onCheckedChanged(ACheckBox checkBox, boolean isChecked);
        }
