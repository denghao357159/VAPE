...
public class NewWindow extends PopupWindow {
    ...
    public NewWindow(Context ct,View add,Object title,boolean bl){
        ...
        nwll8=new NewView(ct,(int)(H()*0.08),(int)(H()*0.08),"CC",1,1,"#ffe6e6e6",10,null);
        nwll9=new NewText(ct,"✕","CC",18,"#000000");
        ...
        if(bl){
        NewWindowcdv=new NewCDV(nwll,(int)(W()*0.65),(int)(H()*0.8),false,true,false,"RC","Di",(int)(W()*0.05),0);
        }else{
        NewWindowcdv=new NewCDV(nwll,(int)(W()*0.65),(int)(H()*0.8),false,true,false,"LC","Di",(int)(W()*0.05),0);
        }
    }
