...
public class PromptBox {
    ...
    public static void show(Context ct,Object sizes,String title,String[] maintext,final Object[] clo1,final Object[] clo2,Object[] add){
        ...
        if(clo1!=null && clo2!=null){
         ...
         pb1 = new NewView(ct, (int)(W() * 0.7*size), (int)(H() * 0.8*size), "CC", 1, 1, "#FFFFFF", 10, null);
         pb2 = new NewView(ct, (int)(W() * 0.65*size), (int)(H() * 0.15), "LC", 1, 1, "#FFFFFF", new int[]{10,10,0,0}, null);
        ...
        pb6 = new NewView(ct, (int)(W() * 0.7) * (int)(size), (int)(H() * 0.1), "CC", 0, 1, "#FFFFFF", new int[]{0,0,10,10}, null);
        
        if(clo==1){
            pb7 = new NewView(ct, (int)(W()*0.7*size/clo-W()*0.0005), (int)(H() * 0.1), "CC", 1, 2, null,null,null);
            _pb7=new NewView(ct, (int)((W() * 0.7*size/clo-W() * 0.0005) * 0.7), (int)(H() * 0.07), "CC", 1, 1, "#FFFFFF", 10, new OnClickListener(){@Override
        public void onClick(View view) {
            if (clo1[1] != null) {
            ((OnClickListener)(clo1[1])).onClick(view);
            }
            if (clo1[2] != null) {
        ...
        _pb7.setOnTouchListener(new View.OnTouchListener(){
                ...
                public boolean onTouch(View view, MotionEvent event) {
                    switch(event.getAction()){
                        ...
                        case 1:
                            ...
                            view.setBackgroundDrawable(ASUI.roundBG("#FFFFFF",10,null,null));
                            break;
                        case 2:
                            break;
                    }
                ...
                pb7 = new NewView(ct, (int)(W()*0.7*size/clo-W()*0.0005), (int)(H() * 0.1), "CC", 1, 2, null,null,null);
                _pb7=new NewView(ct, (int)((W() * 0.7*size/clo-W() * 0.0005) * 0.7), (int)(H() * 0.07), "CC", 1, 1, "#FFFFFF", 10, new OnClickListener(){
                @Override
                public void onClick(View view) {
                ...
                _pb7.setBackgroundDrawable(ASUI.roundBG("#FFFFFF",10,null,null));
                break;
                case 2:
                break;
                ...
                _pb9 = new NewView(ct, (int)((W()*0.7*size/clo-W()*0.0005)* 0.7), (int)(H() * 0.07), "CC", 1, 1, "#FFFFFF", 10, new OnClickListener() {

                @Override
                public void onClick(View view) {
                    
                    ((OnClickListener)(clo2[1])).onClick(view);
                ...
                public boolean onTouch(View view, MotionEvent event) {
                    switch(event.getAction()){
                        ...
                        case 1:
                            ...
                            _pb9.setBackgroundDrawable(ASUI.roundBG("#FFFFFF",10,null,null));
                            break;
                        case 2:
