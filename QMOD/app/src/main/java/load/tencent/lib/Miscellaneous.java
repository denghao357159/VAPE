...
public class Miscellaneous {
    ...
    public static boolean 加入群聊(Context context, String key) {
        ...
        jrql.setData(Uri.parse("mqqopensdkapi://bizAgent/qm/qr?url=http%3A%2F%2Fqm.qq.com%2Fcgi-bin%2Fqm%2Fqr%3Ffrom%3Dapp%26p%3Dandroid%26k%3D" + key));
        ...
        try {
            ...
            // 未安装手Q或安装的版本不支持
           // MyToast.showLong(context, "未安装QQ或安装的版本不支持");
