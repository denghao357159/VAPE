...
//读取文本文件中的内容
    ...
    public static void hint(Context ctx,String text){
        ...
        final NewView txtv =new NewView(ctx, (int)(-2), (int)(-2), "CC", 1, 2,"#ffffff", 30,null);
        final NewView txtv1 =new NewView(ctx, (int)(-2), (int)(-2), "CC", 1, 1, "#ffffff", 30, null);
        final NewText txt = new NewText(ctx,text, "CC", 13, "#000000");
        txt.setPadding(30, 30, 30, 30);
        txtv.setElevation(80);
        txtv1.setElevation(80);
        toast.setView(txtv);
        txtv.addView(txtv1);
        txtv1.addView(txt);
        toast.setGravity(android.view.Gravity.CENTER|android.view.Gravity.BOTTOM,0,(int)(h*0.24));
        UIZoom(txt,110,100,300,null);
        new Handler().postDelayed(new Runnable(){

                @Override
                public void run() {
                    UIMove(txtv,0,0,(int)(h*0.24),0,300,null);
                    UIMove(txt,0,0,(int)(h*0.24),0,300,null);
                }
            }, 50);
        ...
        new Handler().postDelayed(new Runnable(){
                @Override
                public void run() {
                    UIMove(txt,0,0,(int)(h*0.14),0,200,null);
                    UIMove(txtv1,0,0,0,(int)(h*0.14),250,null);
                    UIZoom(txt,110,100,250,null);
                    new Handler().postDelayed(new Runnable(){
