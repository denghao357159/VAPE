...
/*
 * ClassName: AnswerLibrary_AView 
 * Chinese: 线性布局控件
 * Based: AnswerLibrary 3.1
 * © AnswerTame 2022
 * Time: 2022/08/05/00:12
 * By Answer.Dev
 * QQ 2903536884
 */
...
public class AView extends LinearLayout {
        ...
        private static void setSizeWH(Object sizeW, Object sizeH, LinearLayout v) {
                if (sizeW != null && sizeH != null) {
                    v.setLayoutParams(new android.widget.LinearLayout.LayoutParams(Double.valueOf(sizeW.toString()).intValue(), Double.valueOf(sizeH.toString()).intValue()));
                    }
            }
