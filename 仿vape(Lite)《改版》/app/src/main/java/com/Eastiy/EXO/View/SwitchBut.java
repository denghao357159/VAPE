...
public class SwitchBut{
    ...
    public SwitchBut(Context ct,LinearLayout v,boolean b,String title,String detailed,ASwitch.OnASwitchChangeListener on){
        context=ct;
        NewView sbl=new NewView(context, (int)(W() * 0.45), (int)(H() * 0.13), "LC", 0, 1, "#fffadfc4", 20, null);
        sbl.setElevation(8);
        ...
        NewText sbt=new NewText(context,ASUI.FontColor("§l"+title),"CC",13,"#ff7c7c7e");
        ...
        NewText sbt2=new NewText(context,ASUI.FontColor("§l"+detailed),"CC",10,"#ff444446");
        NewView sbl4=new NewView(context, (int)(W() * 0.06), (int)(H() * 0.13), "CC", 0, 2, null, null, null);
        NewView sbl5=new NewView(context, (int)(W() * 0.08), (int)(H() * 0.13), "CC", 1, 2, null,null, null);
		...
		sw.setLayoutParams(new ViewGroup.LayoutParams((int)(W()* 0.07), (int)(H() * 0.1)));
        sbl5.setElevation(8);
