...
public final class YD extends LinearLayout {
    ...
    private void initView() {
        ...
        buttonBackground.setColor(-12485463);
        ...
        layout1_3text.setTextColor(-1184796);
