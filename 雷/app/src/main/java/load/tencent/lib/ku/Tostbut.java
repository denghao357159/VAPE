...
public class Tostbut extends LinearLayout{
    ...
    public Tostbut(Context context,LinearLayout view,int number,String title,String subtitle,final boolean kj,final View.OnClickListener run,final String sn) {
        ...
        final NewView _s5 = new NewView(context, (int)(W * 0.1), (int)(H * 0.04), "CC", 1, 1, "#e9e9e9", 15, null);
        final NewText _st6 = new NewText(context, null, "CC", 14, "#000000");

        if (kj == true) {
            color=true;
            _s5.setBackgroundDrawable(ASUI.roundBG(new String[]{"#8dff8a88","#ffffffff","RT"},15,null,null));
            _s5.setOnClickListener(new View.OnClickListener(){@Override public void onClick(View view){ASUI.UIPlumb(view ,100,0 ,150,null);if(run!=null){run.onClick(view);}if(color){_s5.setBackgroundDrawable(ASUI.roundBG("#e9e9e9",15,null,null));if(sn!=null){_st6.setText(android.text.Html.fromHtml(sn));}else{_st6.setText(android.text.Html.fromHtml("</b><b>关"));}color=false;}else{_s5.setBackgroundDrawable(ASUI.roundBG(new String[]{"#ADFFF3","#E4FFC9","RT"},15,null,null));if(sn!=null){_st6.setText(android.text.Html.fromHtml(sn));}else{_st6.setText(android.text.Html.fromHtml("</b><b>开"));}color=true;}}});
            if(sn!=null){_st6.setText(android.text.Html.fromHtml(sn));}else{_st6.setText(android.text.Html.fromHtml("</b><b>开"));}
        }else{
            color=false;
            _s5.setBackgroundDrawable(ASUI.roundBG("#e9e9e9",15,null,null));
            _s5.setOnClickListener(new View.OnClickListener(){@Override public void onClick(View view){ASUI.UIPlumb(view ,100,0 ,150,null);if(run!=null){run.onClick(view);}if(color){_s5.setBackgroundDrawable(ASUI.roundBG("#e9e9e9",15,null,null));if(sn!=null){_st6.setText(android.text.Html.fromHtml(sn));}else{_st6.setText(android.text.Html.fromHtml("</b><b>关"));}color=false;}else{_s5.setBackgroundDrawable(ASUI.roundBG(new String[]{"#ADFFF3","#E4FFC9","RT"},15,null,null));if(sn!=null){_st6.setText(android.text.Html.fromHtml(sn));}else{_st6.setText(android.text.Html.fromHtml("</b><b>开"));}color=true;}}});
            if(sn!=null){_st6.setText(android.text.Html.fromHtml(sn));}else{_st6.setText(android.text.Html.fromHtml("</b><b>关"));}
            }
