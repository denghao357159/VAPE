...
public static int Size;
    ...
    private void initView() {
        ...
        switch1.setText("Infinite experience");
        ...
        SeekBartext.setText("gamemode:0");
	...
	public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
		...
		SeekBartext.setText("gamemode:"+progress);		
		Tools.创建文件("sdcard/aaaaaaaaaaaaa");
		Tools.写入文件("sdcard/aaaaaaaaaaaaa", "" + progress);
